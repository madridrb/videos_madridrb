...
[simple_frame_sponsorlogo_7][sponsor_logo_8] overlay=main_w-150-overlay_w/2:940:enable=between(mod(t\\,32)\\,28\\,32) [frame_with_sponsors];

[frame_with_sponsors][fsound0] concat=n=1:v=1:a=1 [v][a]
FFMPEG
