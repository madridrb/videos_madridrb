...
[simple_frame_sponsorlogo_6][sponsor_logo_7] overlay=main_w-150-overlay_w/2:940:enable=between(mod(t\\,28)\\,24\\,28) [simple_frame_sponsorlogo_7];

[simple_frame_sponsorlogo_7][fsound0] concat=n=1:v=1:a=1 [v][a]
FFMPEG
