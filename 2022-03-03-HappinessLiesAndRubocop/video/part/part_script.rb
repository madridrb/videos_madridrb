...
[simple_frame_composite] drawtext=textfile=../../title/title_text.txt:fontcolor=0xffffff:fontsize=36:x=10:y=930:fontfile=#{default_font} [simple_frame_composite-text-1];
[simple_frame_composite-text-1] drawtext=textfile=../../title/speaker_text.txt:fontcolor=0xaaaaaa:fontsize=18:x=10:y=970:fontfile=#{default_font} [simple_frame_composite-text-2];
...
[simple_frame_composite-text-8][sponsor_logo_1] overlay=main_w-150-overlay_w/2:940:enable=between(mod(t\\,32)\\,0\\,4) [simple_frame_sponsorlogo_1];
[3]scale=h=-1:w=272 [sponsor_logo_2];
[simple_frame_sponsorlogo_1][sponsor_logo_2] overlay=main_w-150-overlay_w/2:940:enable=between(mod(t\\,32)\\,4\\,8) [simple_frame_sponsorlogo_2];
[4]scale=h=-1:w=272 [sponsor_logo_3];
[simple_frame_sponsorlogo_2][sponsor_logo_3] overlay=main_w-150-overlay_w/2:940:enable=between(mod(t\\,32)\\,8\\,12) [simple_frame_sponsorlogo_3];
[5]scale=h=-1:w=272 [sponsor_logo_4];
[simple_frame_sponsorlogo_3][sponsor_logo_4] overlay=main_w-150-overlay_w/2:940:enable=between(mod(t\\,32)\\,12\\,16) [simple_frame_sponsorlogo_4];
[6]scale=h=-1:w=272 [sponsor_logo_5];
[simple_frame_sponsorlogo_4][sponsor_logo_5] overlay=main_w-150-overlay_w/2:940:enable=between(mod(t\\,32)\\,16\\,20) [simple_frame_sponsorlogo_5];
[7]scale=h=-1:w=272 [sponsor_logo_6];
[simple_frame_sponsorlogo_5][sponsor_logo_6] overlay=main_w-150-overlay_w/2:940:enable=between(mod(t\\,32)\\,20\\,24) [simple_frame_sponsorlogo_6];
[8]scale=h=-1:w=272 [sponsor_logo_7];
[simple_frame_sponsorlogo_6][sponsor_logo_7] overlay=main_w-150-overlay_w/2:940:enable=between(mod(t\\,32)\\,24\\,28) [simple_frame_sponsorlogo_7];
[9]scale=h=-1:w=272 [sponsor_logo_8];
[simple_frame_sponsorlogo_7][sponsor_logo_8] overlay=main_w-150-overlay_w/2:940:enable=between(mod(t\\,32)\\,28\\,32) [simple_frame_sponsorlogo_8];

[simple_frame_sponsorlogo_8][fsound0] concat=n=1:v=1:a=1 [v][a]
FFMPEG
